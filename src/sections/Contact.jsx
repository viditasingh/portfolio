...
const Contact = () => {
  ...
  return (<>
    ...
    <div className="space-y-6 py-8 w-full h-full md:px-10 px-5">
      {/* Resume */}
      <a
        href="https://drive.google.com/file/d/1aYHBpPK7s1YkZg39cauQA80ppVidSano/view?usp=sharing"
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center p-6 rounded-xl hover:border hover:border-green-300 hover:shadow-md group"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center p-6 rounded-xl hover:border hover:border-blue-300 hover:shadow-md group"
      >
